...
export const INSTRUMENTATION_CONNECT = "@opentelemetry/instrumentation-connect";
...
export const INSTRUMENTATION_KAFKAJS = "@opentelemetry/instrumentation-kafkajs";
...
export const INSTRUMENTATION_MYSQL2 = "@opentelemetry/instrumentation-mysql2";
export const INSTRUMENTATION_NESTJS_CORE =
  "@opentelemetry/instrumentation-nestjs-core";
export const INSTRUMENTATION_NET = "@opentelemetry/instrumentation-net";
export const INSTRUMENTATION_OPENAI = "@opentelemetry/instrumentation-openai";
...
export const INSTRUMENTATION_RESTIFY = "@opentelemetry/instrumentation-restify";
export const INSTRUMENTATION_RUNTIME_NODE =
  "@opentelemetry/instrumentation-runtime-node";
export const INSTRUMENTATION_SOCKET_IO =
  "@opentelemetry/instrumentation-socket.io";
export const INSTRUMENTATION_UNDICI = "@opentelemetry/instrumentation-undici";
